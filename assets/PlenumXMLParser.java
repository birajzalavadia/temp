...
public class PlenumXMLParser extends BaseXMLParser {
	public static final String MAIN_PLENUM_URL = "http://www.bundestag.de/xml/plenum/index.xml";
	...
	private static final String PLENUM_SPEAKER_URL = "http://www.bundestag.de/includes/staticdatasources/plenum/speaker.xml";
	...
	private static final String PLENUM_AGENDA_URL = "http://www.bundestag.de/includes/datasources/plenum/tagesordnungen.xml";
	...
	public PlenumObject parseMain(String url) {
		...
		root.getChild(TAG_PLENUM_STATUS).setEndTextElementListener(
				new EndTextElementListener() {
					public void end(String body) {
						currentPlenumObject.setStatus(body);
					}
				});
		root.getChild(TAG_PLENUM_DATE).setEndTextElementListener(
				new EndTextElementListener() {
					public void end(String body) {
						currentPlenumObject.setDate(body);
					}
				});
		root.getChild(TAG_PLENUM_TITLE).setEndTextElementListener(
				new EndTextElementListener() {
					public void end(String body) {
						currentPlenumObject.setTitle(body);
					}
				});
		root.getChild(TAG_PLENUM_IMAGEURL).setEndTextElementListener(
				new EndTextElementListener() {
					public void end(String body) {
						currentPlenumObject.setImageURL(body);
					}
				});
		root.getChild(TAG_PLENUM_IMAGECOPYRIGHT).setEndTextElementListener(
				new EndTextElementListener() {
					public void end(String body) {
						currentPlenumObject.setImageCopyright(body);
					}
				});
		root.getChild(TAG_PLENUM_TEASER).setEndTextElementListener(
				new EndTextElementListener() {
					public void end(String body) {
						currentPlenumObject.setTeaser(body);
					}
				});
		root.getChild(TAG_PLENUM_TEXT).setEndTextElementListener(
				new EndTextElementListener() {
					public void end(String body) {
		...
		root.getChild(TAG_PLENUM_DETAILS_XML).setEndTextElementListener(
				new EndTextElementListener() {
					public void end(String body) {
	...
	public PlenumStreamObject parseStream() {
		...
		streamElement.getChild(TAG_PLENUM_STREAM_URL)
		...
		Element videoStreamElement = root
				.getChild(TAG_PLENUM_STREAM_VIDEOSTREAM);
		videoStreamElement.getChild(TAG_PLENUM_STREAM_VIDEOSTREAM_URL)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						currentPlenumObject.setVideoStreamURL(body);
					}
				});
		videoStreamElement.getChild(TAG_PLENUM_STREAM_VIDEOSTREAM_SOURCE)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						currentPlenumObject.setVideoStreamSource(body);
					}
				});
		videoStreamElement.getChild(TAG_PLENUM_STREAM_VIDEOSTREAM_STARTIMG)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						currentPlenumObject.setVideoStreamImage(body);
					}
				});
		videoStreamElement.getChild(TAG_PLENUM_STREAM_VIDEOSTREAM_TITLE)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						currentPlenumObject.setVideoStreamTitle(body);
					}
				});
		videoStreamElement.getChild(TAG_PLENUM_STREAM_VIDEOSTREAM_DESCRIPTION)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
	 ...
	 */
	public ArrayList<PlenumStreamSourceObject> parseStreamSource(
			String simpleURL) {
		...
		group.setStartElementListener(new StartElementListener() {
			...
			public void start(Attributes attributes) {
				currentStreamSource.setType(attributes
						.getValue(ATT_PLENUM_STREAM_SOURCE_GROUP_TYPE));
			}
		});

		group.getChild(TAG_PLENUM_STREAM_SOURCE_STREAM)
				.setStartElementListener(new StartElementListener() {

					public void start(Attributes attributes) {
						currentStreamSource.setBandwidth(attributes
								.getValue(ATT_PLENUM_STREAM_SOURCE_STREAM_BANDWIDTH));
						currentStreamSource.setHref(attributes
								.getValue(ATT_PLENUM_STREAM_SOURCE_STREAM_HREF));
	...
	public List<PlenumAgendaObject> parseAgenda() {
		...
		agendasElement.getChild(TAG_PLENUM_AGENDA_ITEM_STARTTIME)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						plenumAgendaObject.setStartTime(body);
					}
				});
		agendasElement.getChild(TAG_PLENUM_AGENDA_ITEM_ENDTIME)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						plenumAgendaObject.setEndTime(body);
					}
				});
		agendasElement.getChild(TAG_PLENUM_AGENDA_ITEM_STATUS)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						plenumAgendaObject.setStatus(body);
					}
				});
		agendasElement.getChild(TAG_PLENUM_AGENDA_ITEM_TITLE)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						plenumAgendaObject.setTitle(body);
					}
				});
		agendasElement.getChild(TAG_PLENUM_AGENDA_ITEM_TOP)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						plenumAgendaObject.setTop(body);
					}
				});
		agendasElement.getChild(TAG_PLENUM_AGENDA_ITEM_PROTOCOL)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						plenumAgendaObject.setProtocol(body);
					}
				});
		agendasElement.getChild(TAG_PLENUM_AGENDA_ITEM_LINK)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
						plenumAgendaObject.setLink(body);
					}
				});
		agendasElement.getChild(TAG_PLENUM_AGENDA_ITEM_LINKXML)
				.setEndTextElementListener(new EndTextElementListener() {
					public void end(String body) {
