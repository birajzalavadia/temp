...
public class VisitorsNewsActivityTablet extends BaseActivity {
		...
		if (DataHolder.isOnline(this)) {
			...
			if (showNews) {
				...
				if (orienation == android.content.res.Configuration.ORIENTATION_LANDSCAPE) {
					...
					subMenu1.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							if (!(a instanceof VisitorsOffersActivityTablet)) {
								...
								if (AppConstant.isFragmentSupported) {
									DataHolder.createProgressDialog(VisitorsNewsActivityTablet.this);
								}
								Intent intent = new Intent();
								intent.setClass(VisitorsNewsActivityTablet.this, VisitorsOffersActivityTablet.class);
								intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
								startActivity(intent);
								VisitorsNewsActivityTablet.this.overridePendingTransition(0, 0);
							}
						}
					});
					...
					subMenu2.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							if (!(a instanceof VisitorsLocationsActivityTablet)) {
								Intent intent = new Intent();
								intent.setClass(VisitorsNewsActivityTablet.this, VisitorsLocationsActivityTablet.class);
								intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
								startActivity(intent);
								VisitorsNewsActivityTablet.this.overridePendingTransition(0, 0);
							}
					...
					if (DataHolder.isOnline(VisitorsNewsActivityTablet.this)) {
						...
						subMenu3.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								if (!(a instanceof VisitorsNewsActivityTablet)) {
									...
									DataHolder.createProgressDialog(VisitorsNewsActivityTablet.this);
									Intent intent = new Intent();
									intent.setClass(VisitorsNewsActivityTablet.this, VisitorsNewsActivityTablet.class);
									intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
									startActivity(intent);
									VisitorsNewsActivityTablet.this.overridePendingTransition(0, 0);
								}
					...
					subMenu4.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							if (!(a instanceof VisitorsContactActivity)) {
								...
								DataHolder.createProgressDialog(VisitorsNewsActivityTablet.this);
								Intent intent = new Intent();
								intent.setClass(VisitorsNewsActivityTablet.this, VisitorsContactActivity.class);
								intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
								startActivity(intent);
								VisitorsNewsActivityTablet.this.overridePendingTransition(0, 0);
							}
