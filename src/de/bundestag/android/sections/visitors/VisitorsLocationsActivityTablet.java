...
public class VisitorsLocationsActivityTablet extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (orienation == android.content.res.Configuration.ORIENTATION_LANDSCAPE) {
			...
			subMenu1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (!(a instanceof VisitorsOffersActivityTablet)) {
						...
						if (AppConstant.isFragmentSupported) {
							DataHolder.createProgressDialog(VisitorsLocationsActivityTablet.this);
						}
						Intent intent = new Intent();
						intent.setClass(VisitorsLocationsActivityTablet.this, VisitorsOffersActivityTablet.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
						startActivity(intent);
						VisitorsLocationsActivityTablet.this.overridePendingTransition(0, 0);
					}
				}
			});
			...
			subMenu2.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (!(a instanceof VisitorsLocationsActivityTablet)) {
						Intent intent = new Intent();
						intent.setClass(VisitorsLocationsActivityTablet.this, VisitorsLocationsActivityTablet.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
						startActivity(intent);
						VisitorsLocationsActivityTablet.this.overridePendingTransition(0, 0);
					}
			...
			if (DataHolder.isOnline(VisitorsLocationsActivityTablet.this)) {
				...
				subMenu3.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (!(a instanceof VisitorsNewsActivityTablet)) {
							...
							DataHolder.createProgressDialog(VisitorsLocationsActivityTablet.this);
							Intent intent = new Intent();
							intent.setClass(VisitorsLocationsActivityTablet.this, VisitorsNewsActivityTablet.class);
							intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
							startActivity(intent);
							VisitorsLocationsActivityTablet.this.overridePendingTransition(0, 0);
						}
			...
			subMenu4.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (!(a instanceof VisitorsContactActivity)) {
						...
						DataHolder.createProgressDialog(VisitorsLocationsActivityTablet.this);
						Intent intent = new Intent();
						intent.setClass(VisitorsLocationsActivityTablet.this, VisitorsContactActivity.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
						startActivity(intent);
						VisitorsLocationsActivityTablet.this.overridePendingTransition(0, 0);
					}
