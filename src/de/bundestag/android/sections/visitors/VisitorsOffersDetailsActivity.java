...
public class VisitorsOffersDetailsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int rowId = (Integer) extras.get("index");
		...
		VisitorsArticleObject visitorsDetailsObject = createVisitorsDetailsObject(rowId);
		...
		detailsFragment.showVisitorsOffersDetails(visitorsDetailsObject);
	}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			if (this.listId != null) {
				intent.putExtra(VisitorsOffersListActivity.KEY_LIST_ID, this.listId);
				intent.setClass(this, VisitorsOffersListActivity.class);
			} else {
	...
	private VisitorsArticleObject createVisitorsDetailsObject(int rowId) {
