...
public class VisitorsNewsDetailsActivity extends BaseActivity {
	public int newsId;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (newsDetailsObject != null) {
			...
			detailsFragment.showVisitorNewsDetails(newsDetailsObject, false);
		}
	}
	...
	private NewsDetailsObject createNewsDetailsObject(int newsId) {
		...
		if (newsCursor.getString(newsCursor.getColumnIndex(NewsDatabaseAdapter.KEY_DETAILS_TITLE)) == null) {
			...
			SynchronizeVisitorsNewsDetailsTask synchronizeVisitorsNewsDetails = new SynchronizeVisitorsNewsDetailsTask(newsId);
			synchronizeVisitorsNewsDetails.execute(this);
			newsCursor.close();
