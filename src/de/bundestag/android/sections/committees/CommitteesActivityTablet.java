...
public class CommitteesActivityTablet extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (orienation == android.content.res.Configuration.ORIENTATION_PORTRAIT) {
			...
			tab5.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					if (!(a instanceof CommitteesActivityTablet)) {
						Intent intent = new Intent();
						intent.setClass(a, CommitteesActivityTablet.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
						startActivity(intent);
...
//		}
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		ViewGroup v = null;
		v = (ViewGroup) getWindow().getDecorView().findViewById(R.id.mainMaster);
		if (v == null) {
