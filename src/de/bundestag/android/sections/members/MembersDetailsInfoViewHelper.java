...
public class MembersDetailsInfoViewHelper
{
    public static void createDetailsView(MembersDetailsObject membersDetailsObject, FragmentActivity activity)
    {
        ...
        bio.setText("Veröffentlichungspflichtige Angaben");
        ...
        {
            bioText.setText(TextHelper.customizedFromHtml("Veröffentlichungspflichtige Angaben liegen noch nicht vor."));
        }
        else
        {
            bioText.setText(TextHelper.customizedFromHtml(membersDetailsObject.getDisclosureInformation()));
