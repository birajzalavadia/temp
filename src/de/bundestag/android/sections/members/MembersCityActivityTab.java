...
public class MembersCityActivityTab extends BaseActivity {
	int y, x;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (DataHolder.isLandscape) {
			...
			params = new LinearLayout.LayoutParams(DataHolder.calculatedScreenResolution, heightPopup - (heightPopup * 21 / 100) - 2);
		} else {
			heightPopup = (AppConstant.LEFT_FRAGMENT_LAND + AppConstant.RIGHT_FRAGMENT_LAND) - (((y + rect.bottom) * 3));

			params = new LinearLayout.LayoutParams(DataHolder.calculatedScreenResolution, heightPopup - (heightPopup * 4 / 100) - 2);
		}
		if (DataHolder.isLandscape) {
			params.setMargins(0, rect.right / 2, rect.right, rect.right / 2);
		...
		heading.setText("Bundesländer");
		// Matrix matrix = ivArrow.getImageMatrix();
		// matrix.postRotate(90);
		// ///
		ListView listView = (ListView) findViewById(R.id.listView);
		ArrayList<HashMap<String, Object>> cities = MembersSubpageViewHelperFragment.createMembersCities(this);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				intent.setClass(MembersCityActivityTab.this, MembersSubpageMembersActivity.class);
