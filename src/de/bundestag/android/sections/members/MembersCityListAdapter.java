 ...
 * Add section headers
 */
public class MembersCityListAdapter extends BaseAdapter {
	...
	public MembersCityListAdapter(Context context, ArrayList<HashMap<String, Object>> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.members_city_list_item, parent, false);
